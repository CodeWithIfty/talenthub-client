    ...
    <div className="mt-10 ">
      <div className="p-10 bg-[#12CD6A]">
        <div className="flex items-center justify-between  mx-auto">
          ...
          <button className="uppercase px-5 font-semibold text-white py-3 border-2 rounded-full hover:bg-black hover:border-black hover:shadow-lg transition duration-200 ease-in-out">
            Get Started now
          </button>
        </div>
      </div>
